...
#regular-entry(
  ...
  main-column-second-row: [
    - #strong[Revenue Intelligence and Operational Analytics:] Developed a revenue intelligence platform enabling standardized business metrics including NDR, GRR, Logo Retention, and funnel analytics across domains.
    ...
    - #strong[Data Product Platform and Strategy:] Helped shape a data product strategy focused on reducing fragmentation, improving interoperability, and enabling scalable analytics delivery.
    ...
    - #strong[Metadata-Driven Automation:] Designed a metadata-driven model generation approach turning declarative YAML definitions into governed SQLMesh models.
...
#regular-entry(
  ...
  main-column-second-row: [
    ...
    - #strong[Enterprise Canonical Data Platform:] Developed a semantic data platform enabling standardized interchange of business information across departments.
    ...
    - #strong[Metadata and Data Catalog:] Implemented metadata-driven lineage and business glossary capabilities using semantic technologies and Neo4j.
...
#strong[Strategy:] Analytics strategy, operational intelligence, data product platforms, source-of-truth data

#strong[Modeling:] Semantic modeling, canonical modeling, governed metrics, event-driven analytics, operational modeling

#strong[Methods:] Metadata-driven automation, domain-driven design, Event Modeling, Data Vault, HOOK methodology

#strong[Governance:] Data governance, lineage, metadata management, business glossary, reusable semantic definitions

#strong[Technologies:] Snowflake, SQLMesh, dbt, SQLGlot, Kafka, GraphQL, Neo4j, AWS, Azure
