# Artur Mrozowski's CV

- Phone: +46 73 301 77 32
- Email: [artmro@gmail.com](mailto:artmro@gmail.com)
- Location: Vellinge, Sweden
- GitHub: [afuyo](https://github.com/afuyo)
...
# Experience
## **Senior Analytics Engineer**, Tryg

Oct 2023 – present

- **Revenue Intelligence and Operational Analytics:** Developed a revenue intelligence platform enabling standardized business metrics including NDR, GRR, Logo Retention, and funnel analytics across domains.
...
- **Data Product Platform and Strategy:** Helped shape a data product strategy focused on reducing fragmentation, improving interoperability, and enabling scalable analytics delivery.
...
- **Metadata-Driven Automation:** Designed a metadata-driven model generation approach turning declarative YAML definitions into governed SQLMesh models.
...
## **Senior Data Architect**, Lundbeck
...
## **Data Engineer / Data Architect**, Tryg
...
- **Enterprise Canonical Data Platform:** Developed a semantic data platform enabling standardized interchange of business information across departments.
...
- **Metadata and Data Catalog:** Implemented metadata-driven lineage and business glossary capabilities using semantic technologies and Neo4j.
...
# Skills
**Strategy:** Analytics strategy, operational intelligence, data product platforms, source-of-truth data

**Modeling:** Semantic modeling, canonical modeling, governed metrics, event-driven analytics, operational modeling

**Methods:** Metadata-driven automation, domain-driven design, Event Modeling, Data Vault, HOOK methodology

**Governance:** Data governance, lineage, metadata management, business glossary, reusable semantic definitions

**Technologies:** Snowflake, SQLMesh, dbt, SQLGlot, Kafka, GraphQL, Neo4j, AWS, Azure
...
## **Lead Enterprise Architecture Program on Azure - Microsoft**

2017



## **Data Modelling Master Class - Steve Hoberman**

2016



## **Data Vault Certified Data Modeler, DVCDM**
...
# Education
## **Lund University**, Bachelor of Science in System Analysis- Faculty of Informatics.
...
## **Building Semantic Data Hub with LPG, GraphQL and Kafka Streams**
